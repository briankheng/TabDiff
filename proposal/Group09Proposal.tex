...
For each of two network intrusion datasets we get a labelled training set and have to submit a fixed number of synthetic normal rows: 40,000 for NSL-KDD~\cite{tavallaee2009nslkdd} and 70,000 for UNSW-NB15~\cite{moustafa2015unsw}. These samples are used to train predefined anomaly detectors, ECOD and Isolation Forest, which are evaluated using AUPRC on hidden validation and test sets.
